...
const getShoesInCategory = (
	...
	switch (category) {
		case "men":
			return MEN_SHOE_DATA.items.slice(start, start + amount);
		case "women":
			return WOMEN_SHOE_DATA.items.slice(start, start + amount);
		case "kids":
			return KIDS_SHOE_DATA.items.slice(start, start + amount);
...
const getCategoryData = (category: string) => {
	switch (category) {
		case "men":
			return {
				id: MEN_SHOE_DATA.id,
				name: MEN_SHOE_DATA.routeName,
				imageUrl: MEN_SHOE_DATA.mainImg,
			};
		case "women":
			return {
				id: WOMEN_SHOE_DATA.id,
				name: WOMEN_SHOE_DATA.routeName,
				imageUrl: WOMEN_SHOE_DATA.mainImg,
			};
		case "kids":
			return {
				id: KIDS_SHOE_DATA.id,
				name: KIDS_SHOE_DATA.routeName,
				imageUrl: KIDS_SHOE_DATA.mainImg,
			};
